    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white/70 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/50">
        ...
        <div className="space-y-1 mb-6">
          <label className="text-sm font-bold text-red-900 uppercase tracking-wider flex items-center gap-1.5 text-[10px]">Access Portal Role</label>
          <select 
             className="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-slate-800 bg-white/70 focus:border-red-500 focus:ring-2 focus:ring-red-200 outline-none transition-all font-semibold"
             value={selectedRole}
             onChange={(e) => {
